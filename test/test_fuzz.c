...
struct filename_node* filename_push(struct filename_node* head, char* str, int is_w) {
...
static char* sysfs_filenames_roster[SYSFS_FILENAMES_ROSTER_SIZE] = {
  ...
  "/sys/kernel/fas/sessions_each_file",
...
read_action:
    ...
    case 6: {
      ...
      *filenames_stack = filename_push(*filenames_stack, A_get_sysfs_filename(), 0);
      break;
